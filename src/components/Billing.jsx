...
const Billing = () => (
  ...
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      Build Your Unique <br className="sm:block hidden"/>
      Online Presence
      </h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      Pick a template and customize anything,
      or answer a few questions and get a free
      website designed just for you. 
      You can always add more features as you grow.
      </p>
